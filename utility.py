...
clf1 = joblib.load("pickle_files/nb_small/nb_normal.pkl")
clf2 = joblib.load("pickle_files/nb_small/nb_pos.pkl")
clf3 = joblib.load("pickle_files/nb_small/nb_syn.pkl")
